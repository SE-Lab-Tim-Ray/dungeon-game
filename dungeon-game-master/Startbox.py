...
def startbox():
    ...
    input_box_show_var = tk.Label(startscreen, text=show_var, width = 23, font=('arial', 24))
    input_box_show_var.pack(side=tk.TOP, expand=tk.YES)
    input_box_show_var["bg"] = "white"

    # show text
    show_var = "Enter your name: "
    input_box_show_var = tk.Label(startscreen, text=show_var, width = 23, font=('arial', 18))
    input_box_show_var.pack(side=tk.TOP, expand=tk.YES)
    input_box_show_var["bg"] = "white"

    # the entry text box
    input_box_text = tk.Entry(startscreen,  font=('arial', 18))
    ...
    start_button = tk.Button(startscreen, text="Start", width=20, font=('arial', 18), command=lambda: close_the_window())

...
# Building the maze
MAZE_WIN_IMG = os.path.join(main_dir, 'data', '1_win.png')
MAZE_LOSE_IMG = os.path.join(main_dir, 'data', '1_lose.png')
NICKNAME_LOCATION = (280, 350)
NICKNAME_FONT_SIZE = 40
NICKNAME_TEXT = "Well done "
NICKNAME_LEADING = 20
MAZE_MAP_IMG = os.path.join(main_dir, 'data', '1_maze.png')
MAZE_MAP = os.path.join(main_dir, 'data', '1_maze.txt')
CHARACTER_IMG = os.path.join(main_dir, 'data', '1_char.png')
...
RAT_IMG = os.path.join(main_dir, 'data', 'rat.png')
